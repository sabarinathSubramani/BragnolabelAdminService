...
public class DropWizardApplicaton extends Application<DropWizardConfiguration> {
	...
	public void initialize(Bootstrap<DropWizardConfiguration> bootstrap) {
		...
		hibernateBundle =
				new HibernateBundle<DropWizardConfiguration>(OrderEntity.class, OrderLineItemEntity.class, ShippingAddressEntity.class, ClientEntity.class, ShipmentTrackingEntity.class) {
			@Override
